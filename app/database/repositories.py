...
async def seed_default_faqs(s):
    ...
    },
    {
        ...
        "answer": "Сразу сообщите о пожаре по номеру 101 или 112, предупредите окружающих и покиньте опасную зону, если путь безопасен.",
        "variants": [
            "Сразу сообщите о пожаре по номеру 101 или 112, предупредите окружающих и покиньте опасную зону, если путь безопасен.",
    ...
    },
    {
        ...
        "answer": "Нет. Сначала необходимо отключить электроприбор от сети. Воду нельзя использовать для тушения оборудования, находящегося под напряжением.",
        "variants": [
